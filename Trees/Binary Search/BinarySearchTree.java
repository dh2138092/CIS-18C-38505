...
public class BinarySearchTree<AnyType extends Comparable<? super AnyType>>
{
    ...
    private void preorderTraverse(BinaryNode<AnyType> node, int indent)
    {
    	if (node != null)
    	{
    		...
    		preorderTraverse(node.left, indent + 1);
    		preorderTraverse(node.right, indent + 1);
    	}
    }
    
    private void inorderTraverse(BinaryNode<AnyType> node)
    {
    	if (node != null)
    	{
    ...
    { 
    	if (t == null)
    	{
    		...
    		System.out.println("Duplicate Item Exception :" + x.toString());
